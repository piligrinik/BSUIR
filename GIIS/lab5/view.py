...
buttons = ["Draw the line", "Draw the circle", "Draw the ellipse", "Draw the hyperbola", "Draw the parabola", "Draw the curve",
           "Cube transfer", "Draw the polygon", "smth"]
...
button_cube.place(relx=0.1, rely=0.7, anchor="w")
button_polygon = ttk.Button(root, text=buttons[7], command=lambda: draw_polygon(), width=28)
button_polygon.place(relx=0.1, rely=0.8, anchor="w")


for i, btn_text in enumerate(buttons[8:]):
    btn = ttk.Button(root, text=btn_text, width=28)
    btn.place(relx=0.1, rely=0.9 + i * 0.1, anchor="w")
