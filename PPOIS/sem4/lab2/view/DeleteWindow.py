...
class DeleteWindow(tk.Toplevel):
    def __init__(self, root, main_window):
        ...
        self.title = "Delete soccer players"
        self.configure(background="#A2B5CD")
        self.build_buttons()
        self.date_str = ""

    def build_buttons(self):
        # bith date and name
        ttk.Label(self, text="Player's first name and date of birth:", background="#A2B5CD").pack()
        ...
        self.birth_date_entry.config(state=tk.DISABLED, background="#A2B5CD")
        self.birth_date_entry.pack(pady=(10, 0))
        self.enable_dob_name = tk.BooleanVar()
        self.dob_name_checkbutton = ttk.Checkbutton(self, text="Delete by name and birth date",
                                                    command=lambda: self.switch_state(self.name_entry,
                                                                                      self.enable_dob_name,
                                                                                      self.birth_date_entry),
                                                    variable=self.enable_dob_name)
        self.dob_name_checkbutton.pack(pady=(10, 0))

        # position
        ttk.Label(self, text="Player's position:", background="#A2B5CD").pack(pady=(20, 0))
        self.position_entry = ttk.Entry(self, state=tk.DISABLED)
        self.position_entry.pack(pady=(5, 0))
        self.enable_position = tk.BooleanVar()
        self.position_checkbutton = ttk.Checkbutton(self, text="Delete by position",
        ...
        # squad
        ttk.Label(self, text="Player's squad:", background="#A2B5CD").pack(pady=(20, 0))
        self.squad_entry = ttk.Entry(self, state=tk.DISABLED)
        self.squad_entry.pack(pady=(5, 0))
        self.enable_squad = tk.BooleanVar()
        self.squad_checkbutton = ttk.Checkbutton(self, text="Delete by squad",
        ...
        # soccer team
        ttk.Label(self, text="Player's team:", background="#A2B5CD").pack(pady=(20, 0))
        ...
        self.soccer_team_checkbutton = ttk.Checkbutton(self, text="Delete by soccer team",
    ...
    def delete(self, event = None):
        ...
        search = SearchCriteria(self.name_entry.get(), self.date_str, self.position_entry.get(), self.squad_entry.get(),
                                              self.soccer_team_entry.get(), self.town_entry.get(), criteria)
        deleted_players_quantity = self.main_window.file.delete_players(search)
        if deleted_players_quantity > 0:
            messagebox.showinfo("Succes", f"Deleted {deleted_players_quantity} player(s)")
        else:
            messagebox.showinfo("No info found", "No players were found by the criteria you picked")
